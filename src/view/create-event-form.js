...
import {getFormattedDate, getObjectByKeyInArray, getRandomArrayItem, getRandomNumber} from '../utils';
...
class CreateEventForm {
  ...
  getEventPhotos(photos, description) {
              ...
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  ...
                  <div class="event__field-group  event__field-group--time">
                    ...
                    <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${getFormattedDate(startDate, 'YY[/]MM[/]DD HH:MM')}">
                    &mdash;
                    <label class="visually-hidden" for="event-end-time-1">To</label>
                    <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${getFormattedDate(endDate, 'YY[/]MM[/]DD HH:MM')}">
                  </div>
                ...
                <section class="event__details">
                  ${this.getExtraOffers(eventType, offers)}
                  ${this.getEventPhotos(destination.photos, destination.description)}
                </section>
              </form>
            </li>
    `;
